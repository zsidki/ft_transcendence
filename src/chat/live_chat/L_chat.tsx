...
const LChatTopbar = (props:{title: string, Subtitle:string, setStatus?: Function, setStat: Function, isroom: boolean}) => {
...
const Lchat = (props:{_slct?: string, setStatus: Function}) => {
    ...
    if (props._slct === "0")
        var selected = <LChatTopbar  title={otheruser?.user_name} Subtitle="Direct Messege"  setStatus={props.setStatus} isroom={false} setStat={setStat} />;
    else
        selected = <LChatTopbar  title={room?.name} Subtitle="Room" setStatus={props.setStatus} isroom={true}  setStat={setStat} />
